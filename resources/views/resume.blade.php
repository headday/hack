...
<div class="form-check">
    <h2>Фильтры</h2>
    <div><input class="form-check-input" type="checkbox" value="" name="resume_stage">
        ...
        <div class="card-body">
          ...
          @if ($role = '2')
            <form method="POST" action="{{route('addFavorite')}}">
              ...
              <svg id="heart_btn" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart" viewBox="0 0 16 16">
